...
class Customer_registration(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE) # this line is compulsory, it ensure the django registration file recognize our own model for registration
